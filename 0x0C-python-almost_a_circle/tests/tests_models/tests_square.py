...
class TestSquareMethods(unittest.TestCase):
    ...
    def test_new_squares(self):
        """Test the creation of new squares."""
        new = Square(1, 1)
        new2 = Square(1, 1)
    ...
    def test_incorrect_amount_attrs(self):
        """Test error raising with no arguments passed."""
        with self.assertRaises(TypeError):
            new = Square()

    def test_incorrect_amount_attrs_1(self):
        """Test error raising with too many arguments passed."""
        with self.assertRaises(TypeError):
            new = Square(1, 1, 1, 1, 1)

    def test_access_private_attrs(self):
        """Test trying to access a private attribute."""
        new = Square(1)
    ...
    def test_invalid_value_attrs(self):
        """Test passing invalid values."""
        with self.assertRaises(ValueError):
            new = Square(0)

    def test_invalid_value_attrs_2(self):
        """Test passing invalid values."""
        with self.assertRaises(ValueError):
            new = Square(1, -1)

    def test_invalid_value_attrs_3(self):
        """Test passing invalid values."""
        with self.assertRaises(ValueError):
            new = Square(1, 1, -1)
