...
class TestBaseMethods(unittest.TestCase):
    ...
    def test_constructor_args_2(self):
        """The tests constructor signature with 2 notself args"""
        with self.assertRaises(TypeError) as e:
...
were given"
    ...
    def test_to_json_string(self):
        """The test to_json_string method"""
    ...
    def test_from_json_string(self):
        """The test from_json_string method"""
    ...
    def test_save_to_file_1(self):
        """The test save_to_file_method with empty_file"""
        Rectangle.save_to_file([])
        with open("Rectangle.json", mode="r") as myFile:
            self.assertEqual([], json.load(myFile))

    def test_save_to_file_2(self):
        """The test save_to_file method with None as file """
        Rectangle.save_to_file(None)
        with open("Rectangle.json", mode="r") as myFile:
            self.assertEqual([], json.load(myFile))

    def test_save_to_file_3(self):
        """The test save_to_file method """
        r1 = Rectangle(10, 7, 2, 8)
        r2 = Rectangle(2, 4)
        s2f = [r1, r2]
    ...
    def test_load_from_file(self):
        """The test load_from_file method"""
        r1 = Rectangle(10, 7, 2, 8)
        r2 = Rectangle(2, 4)
        list_in = [r1, r2]
    ...
    def test_load_from_file_empty_file(self):
        """The test use of load_from_file with empty file"""
        try:
            os.remove("Rectangle.json")
        except Exception:
            pass
